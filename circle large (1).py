...
class EnlargeShrinkCircle:
    def __init__(self):
        ...
        self.canvas.create_oval(
            ...
            100 + self.radius, 100 + self.radius,fill = "blue" ,tags = "oval")
    ...
    def increaseCircle(self, event):
        ...
        self.canvas.create_oval(
            100 - self.radius, 100 - self.radius, 
            100 + self.radius, 100 + self.radius,fill = "red", tags = "oval")
    def decreaseCircle(self, event):
        ...
        self.canvas.create_oval(
            100 - self.radius, 100 - self.radius, 
            100 + self.radius, 100 + self.radius, fill ="green",tags = "oval")
